...
public class WXBizDataCrypt {
     ...
     * @throws Exception
     */
    public WXUserInfoDecryptDataDTO decrypt(String encryptedData, String iv) throws Exception {
        ...
        val model = JSONUtil.toBean(jsonStr, WXUserInfoDecryptDataDTO.class);
        if (!this.appId.equals(model.getWatermark().getAppid())) {
            throw new Exception("Illegal Buffer");
        }
        return model;
    }
